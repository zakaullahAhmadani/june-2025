...
<head>
  ...
  <!-- Page Title -->
  <title>contact-Used Furniture Buyers Dubai | Sell Used Furniture for Best Price</title>
...
<body>
 ...
 <section class="hero-section d-flex align-items-center justify-content-center text-center" style="
    background: url('{{ asset('images/Used Home Furniture Buyers in Dubai.webp') }}') center center / cover no-repeat;
    height: 400px;
    position: relative;
">
    ...
    <div class="container position-relative">
        ...
        <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
            <ol class="breadcrumb bg-transparent p-0 m-0">
                ...
                <li class="breadcrumb-item active text-black" aria-current="page">Contact Us</li>
            </ol>
        </nav>
    </div>
</section>
