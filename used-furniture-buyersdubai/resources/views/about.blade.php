...
<head>
  ...
  <!-- Page Title -->
  <title>about-Used Furniture Buyers Dubai | Sell Used Furniture for Best Price</title>
...
<body>
 ...
 <section class="hero-section d-flex align-items-center justify-content-center text-center" style="
    background: url('{{ asset('images/furniture-pickup.webp') }}') center center / cover no-repeat;
    height: 400px;
    position: relative;
">
    ...
    <div class="container position-relative">
        <h1 class="display-4 fw-bold text-black">About Us</h1>
