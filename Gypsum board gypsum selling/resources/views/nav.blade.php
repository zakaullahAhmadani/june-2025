...
<div class="navbar-top d-none d-lg-flex justify-content-between align-items-center py-2 px-3">
  <div class="contact-center">
    <span class="me-4 text-white"><i class="bi bi-telephone-fill me-2 text-white"></i> +966 50 143 4156</span>
    <span class="text-white"><i class="bi bi-envelope-fill me-2 text-white"></i> info@gypsumboardandceilingworks.shop</span>
  </div>
  ...
  <div class="container-fluid px-lg-4">
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      ...
      <div class="d-flex justify-content-center pb-3 pb-lg-0">
        <a href="https://wa.me/966501434156" class="book-btn btn btn-primary px-4 py-2 text-decoration-none">
