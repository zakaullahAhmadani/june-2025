...
<style>
 ...
 <main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    <h2 class="hero-title mb-4">بيع جميع أنواع الخردة المعدنية</h2>
    ...
    <section class="mobile-hero-section d-lg-none">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h3 class="mobile-hero-title mb-4">بيع جميع أنواع الخردة المعدنية</h3>
                    <p class="mobile-hero-text mb-5">
                        نقوم بشراء جميع أنواع الخردة المعدنية: أسلاك الحديد، الأسلاك النحاسية، الألومنيوم، البطاريات المستخدمة، خردة تكييف الهواء.<br>
                        نحن نشتري جميع أنواع الخردة المعدنية في المملكة العربية السعودية - الرياض، والمعادن والمواد غير الحديدية.<br>
                        اتصل بنا للحصول على عرض أسعار مخصص وخالي من المتاعب لمشروعك في السعودية - الرياض.
                    </p>
                    <div class="mobile-hero-buttons d-flex justify-content-center gap-3 flex-wrap">
                        <a href="https://wa.me/+966543282605" class="btn btn-whatsapp" target="_blank">
                            <i class="fab fa-whatsapp me-2"></i> WhatsApp
                        </a>
                        <a href="tel:+966543282605" class="btn btn-call">
...
<style>
    ...
    .hero-section::before, .mobile-hero-section::before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
    ...
    .hero-section .container, .mobile-hero-section .container {
        position: relative;
        z-index: 2;
    }
...
<section class="py-5 bg-primary text-white">
    <div class="container text-center">
        <h3 class="mb-4">هل لديك كمية كبيرة من الخردة؟</h3>
        <p class="lead mb-4">اتصل بنا الآن للحصول على أفضل سعر وتقييم مجاني</p>
         <div class="hero-buttons d-flex justify-content-center gap-4">
                        <a href="https://wa.me/+966543282605" class="btn btn-whatsapp" target="_blank">
                            <i class="fab fa-whatsapp me-2"></i> WhatsApp
                        </a>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <h5 class="text-primary">شراء الخردة في المملكة</h5>
                <h2 class="mb-3">عملية شراء الخردة في جدة والرياض</h2>
                <p class="lead text-muted">لدينا عملية عمل بسيطة حيث تتصل بنا فنقوم بمعاينة سريعة ثم الدفع واستلام الخردة</p>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <div class="card-img-top position-relative p-4">
                        <img src="images/step-one.png" class="img-fluid rounded-circle" style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #e69b00;" alt="اتصل بنا">
                        <span class="position-absolute top-0 start-0 translate-middle badge bg-primary rounded-circle" style="width: 40px; height: 40px; font-size: 1.2rem;">1</span>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title text-primary">اتصل بنا</h5>
                        <p class="card-text">اتصل بنا وحدد موعدًا لمعاينة الخردة ومعرفة موقعها في جدة أو الرياض</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <div class="card-img-top position-relative p-4">
                        <img src="images/step-two.jpg" class="img-fluid rounded-circle" style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #e69b00;" alt="معاينة الخردة">
                        <span class="position-absolute top-0 start-0 translate-middle badge bg-primary rounded-circle" style="width: 40px; height: 40px; font-size: 1.2rem;">2</span>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title text-primary">معاينة الخردة</h5>
                        <p class="card-text">يصل فريقنا إلى موقعك في جدة أو الرياض لإجراء معاينة سريعة للخردة</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <div class="card-img-top position-relative p-4">
                        <img src="images/step-three.jpg" class="img-fluid rounded-circle" style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #e69b00;" alt="دفع ثمن الخردة">
                        <span class="position-absolute top-0 start-0 translate-middle badge bg-primary rounded-circle" style="width: 40px; height: 40px; font-size: 1.2rem;">3</span>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title text-primary">دفع ثمن الخردة</h5>
                        <p class="card-text">بعد إتمام الأوراق اللازمة، يتم تحويل المبلغ إلى حسابك مباشرة</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <div class="card-img-top position-relative p-4">
                        <img src="images/step-four.jpg" class="img-fluid rounded-circle" style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #e69b00;" alt="استلام الخردة">
                        <span class="position-absolute top-0 start-0 translate-middle badge bg-primary rounded-circle" style="width: 40px; height: 40px; font-size: 1.2rem;">4</span>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title text-primary">استلام الخردة</h5>
                        <p class="card-text">نقوم بآخر مرحلة وهي استلام الخردة من موقعك في جدة أو الرياض</p>
                    </div>
                </div>
            </div>
        </div>
