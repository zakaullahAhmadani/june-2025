<style>
    ...
    * {
    ...
    .contact-card-ar::before {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(135deg, rgba(0, 94, 184, 0.03) 0%, rgba(252, 191, 30, 0.03) 100%);
        z-index: 0;
    }
...
<section class="contact-section-ar">
    <div class="contact-container-ar">
        <div class="contact-header-ar">
            <h2>تواصل معنا</h2>
            <p>نحن هنا لمساعدتك في جميع احتياجات صيانة المكيفات والغسالات الخاصة بك</p>
        </div>
                ...
                <form id="contactFormAr" method="POST" action="{{ route('contact.submit') }}">
                    ...
                    <div class="form-group-ar">
                        ...
                        <select id="service-ar" name="service" class="form-control-ar" required>
                            ...
                            <option value="تنظيف المكيفات">تنظيف المكيفات</option>
            ...
            <div class="contact-cards-container-ar">
                ...
                <div class="contact-card-ar">
                    ...
                    <div class="contact-content-ar">
                        <h3>اتصل بنا</h3>
                        <a href="tel:+966531482186">+966 53 148 2186</a>
                        <p>متاح على مدار الساعة للخدمات الطارئة</p>
                    </div>
                </div>
                ...
                <div class="contact-card-ar">
                    ...
                    <div class="contact-content-ar">
                        ...
                        <a href="mailto:info@automaticwashingmachineandacrepair.shop">info@automaticwashingmachineandacrepair.shop</a>
                        <p>رد خلال 24 ساعة</p>
                    </div>
                </div>
                ...
                <div class="contact-card-ar">
                    ...
                    <div class="contact-content-ar">
                        ...
                        <p>الخدمة متاحة في جميع أنحاء المدينة</p>
                    </div>
                </div>
            </div>
        </div>
