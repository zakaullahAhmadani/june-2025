  ...
  @include('nav')
    ...
    <section class="hero" dir="rtl">
        <div class="hero-content">
            <h1>خدمات صيانة احترافية للمكيفات والغسالات</h1>
            <p>نقدم حلولاً متكاملة لصيانة وإصلاح جميع أنواع المكيفات والغسالات الأتوماتيكية بأسعار تنافسية وجودة عالية.</p>
...
<a href="https://wa.me/966531482186" class="whatsapp-hero-btn pulse">
  تواصل عبر واتساب
