...
<head>
   ...
   <title>About Us &#8211; Pickup Delivery Dubai</title>
...
<body>
    ...
    <div class="contact-center">
      <span><i class="bi bi-telephone-fill"></i> +971582828757</span>
      <span><i class="bi bi-whatsapp"></i> +971582828757</span>
 ...
 <nav class="navbar navbar-expand-lg navbar-main shadow-sm" style="height: 80px; padding: 0;">
  ...
  .navbar-brand img {
    ...
    <a class="nav-link dropdown-toggle no-focus-border" href="{{ url('/services') }}" 
...
.no-focus-border:focus {
    ...
    border-color: transparent !important;
        ...
        <a href="https://api.whatsapp.com/send?phone=971582828757" class="book-btn text-decoration-none d-flex align-items-center">
          BOOK NOW <i class="bi bi-arrow-up-right"></i>
        </a>
      </div>
    </div>
  </nav>
        <section class="cs_hero cs_style_1 cs_type_1 position-relative overflow-hidden" style="background-image: url('images/240_F_402473242_GrZKQ4H7tvexDg0qP5JwgnAsTIoi2IN9.jpg'); background-size: cover; background-position: center;">
    <!-- Background Overlay -->
    <div class="position-absolute top-0 start-0 w-100 h-100 cs_primary_bg" style="opacity: 0.7;"></div>
    
    <div class="container position-relative z-index-1 py-5">
        <div class="row">
            <div class="col-lg-8 col-md-10">
                <div class="cs_hero_text text-start text-white">
                    <p class="cs_hero_subtitle mb-3 fs-5 fw-bold">Pickup Delivery Dubai</p>
                    <h1 class="cs_hero_title display-4 fw-bold mb-3 animate__animated animate__fadeInUp">
                       About Us
                    </h1>
<br>
                    <div class="pe-lg-5 me-lg-5">
                        <p class="cs_hero_subtitle mb-4 fs-5">
                            We offer fast, safe, and affordable pick up and delivery services in Dubai with same-day service and real-time tracking.
                        </p>

                        <div class="mt-4 pt-2">
                            <a class="btn btn-primary btn-lg px-4 py-3 rounded-1 animate__animated animate__fadeInLeft" 
                               href="https://wa.me/+971582828757" target="_blank">
                                <span>Book Now</span>
    ...
    <section>
        ...
        <div class="container">
            <div class="text-center mb-5">
                ...
                <h2 class="cs_section_title animate__animated animate__pulse">WE DELIVER RELIABLE, AFFORDABLE SERVICES WITH DEDICATED SUPPORT FOR SATISFACTION.</h2>
            </div>
            ...
            <div class="row cs_row_gap_40 cs_gap_y_40 align-items-center">
                <div class="col-xl-4 animate__animated animate__fadeInLeft">
                    <div class="cs_features_thumbnail_1 position-relative">
                        <img src="images/download5.jpeg" loading="lazy" alt="Feature Image" class="img-fluid">
                    </div>
                </div>
                ...
                <div class="col-xl-4 animate__animated animate__fadeInDown">
                    ...
                    <a class="cs_btn" href="https://api.whatsapp.com/send?phone=+971582828757">
                        <span>CALL NOW</span>
                ...
                <div class="col-xl-4 animate__animated animate__fadeInRight">
                    <div class="cs_features_thumbnail_2 position-relative">
                        <img src="images/download7.jpeg" loading="lazy" alt="Feature Image" class="img-fluid">
                    </div>
                    <div class="cs_features_thumbnail_3">
                        <img src="images/download6.jpeg" loading="lazy" alt="Feature Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Testimonial Section -->
<section class="py-5" style="background-image: url('Assets/testimonialbg.jpg'); background-size: cover;">
  <div class="container py-5">
    <div class="text-center mb-5">
      <h3 class="text-uppercase fw-semibold mb-3">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="
10.8155 4.87912 11.1205C5.18392 11.4256 5.38605 11.7923 5.47992 12.2141C5.68338 13.0667 5.40125 14.0045 4.74365 14.6621ZM5.25618 10.7435C5.06331 10.5513 4.84317 10.3885 4.60285 10.2605L10.2605 4.60293C10.3884 4.84331 10.551 5.06354 10.7431 5.25653C10.936 5.44873 11.1561 5.61146 11.3965 5.73947L5.73885 11.3971C5.61092 11.1567 5.44829 10.9365 5.25618 10.7435ZM12.7711 10.4549C13.4562 10.4549 14.1455 10.7395 14.6621 11.256C15.1919 11.7859 15.4789 12.4963 15.4658 13.1973L15.2189 12.9501C14.9178 12.6497 14.5099 12.4809 14.0846 12.4809C13.6593 12.4809 13.2513 12.6497 12.9503 12.9501C12.8011 13.0989 12.6828 13.2757 12.6023 13.4704C12.5217 13.6651 12.4806 13.8738 12.4813 14.0845C12.4806 14.2952 12.5217 14.504 12.6023 14.6987C12.6828 14.8934 12.8011 15.0702 12.9503 15.2189L13.1973 15.4661C12.4935 15.4736 11.7861 15.192 11.2559 14.6621C10.5983 14.0045 10.3162 13.0667 10.5205 12.2099C10.611 11.7964 10.8194 11.418 11.1205 11.1205C11.5711 10.6699 12.1623 10.4549 12.7711 10.4549ZM11.3959 10.2611C11.1558 10.3889 10.936 10.5514 10.7434 10.7435C10.5514 10.9361 10.3889 11.156 10.261 11.396L8.37752 9.5128L9.51245 8.37787L11.3959 10.2611Z" fill="currentColor"></path>
        </svg>
        Testimonial
      ...
      <h2 class="display-4 mb-0">What our clients say <br> About Us</h2>
    </div>
...
<div class="container py-5">
  ...
  <div class="row g-4" id="testimonialCarousel">
    <!-- Testimonial 1 -->
    <div class="col-lg-4">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body p-4">
          <div class="d-flex align-items-center mb-4">
            <img src="images/P2UGM57.jpg" loading="lazy" alt="Vita Zheng" class="rounded-circle me-3" width="60">
            <div>
...
Dubai Marina</p>
          ...
          <blockquote class="mb-0">
            ...
            <p class="fs-5">“I needed a last-minute sofa pickup and delivery across town, and these guys handled it flawlessly. They arrived on time, packed everything securely, and delivered it without a scratch. Highly recommended!”</p>
          </blockquote>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body p-4">
          <div class="d-flex align-items-center mb-4">
            <img src="images/E3CC8GB.jpg" loading="lazy" alt="Ahmad Alhemeiri" class="rounded-circle me-3" width="60">
            <div>
              <div class="text-warning mb-1">
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i>
              ...
              <h5 class="mb-0">Laura Ferguson</h5>
              <p class="mb-0">Jumeirah Lake Towers (JLT)</p>
            </div>
          </div>
          <blockquote class="mb-0">
            <i class="bi bi-quote fs-1 text-muted opacity-25"></i>
            <p class="fs-5">“Great experience from start to finish! I had a washing machine picked up and delivered to my new apartment. Smooth process, excellent communication, and no hidden charges.”</p>
          </blockquote>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body p-4">
          <div class="d-flex align-items-center mb-4">
            <img src="images/RHDZL5A.jpg" loading="lazy" alt="John Doe" class="rounded-circle me-3" width="60">
            <div>
              <div class="text-warning mb-1">
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i>
              ...
              <h5 class="mb-0">Audrey Stevenson</h5>
               <p class="mb-0">Downtown Dubai</p>
            </div>
          </div>
          <blockquote class="mb-0">
            <i class="bi bi-quote fs-1 text-muted opacity-25"></i>
            <p class="fs-5">“Their same-day furniture pick up and delivery service saved me during my move. They were fast, professional, and very affordable. I’ll definitely use them again!”</p>
          </blockquote>
        </div>
      </div>
    </div>
  ...
  <!-- Optional Carousel Controls (if you want sliding) -->
...
<style>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-8 mb-4 mb-md-0">
        <div class="d-flex align-items-center mb-3">
          ...
          <h6 class="text-uppercase mb-0">NEWS & UPDATES</h6>
        </div>
        <h2 class="mb-0">Latest New and Blog</h2>
      </div>
  ...
  <!-- <div class="col-lg-4">
    <div class="card border-0 h-100 shadow-sm hover-shadow-lg transition-all">
      <a href="/" class="overflow-hidden">
        <img src="Assets/What-is-vent-mode-in-air-conditioner.avif" class="card-img-top w-100 hover-zoom" alt="What is vent mode in air conditioner?" loading="lazy">
      </a>
      <div class="card-body position-relative bg-white rounded-bottom p-4">
        <div class="position-absolute top-0 start-0 translate-middle-y bg-primary text-white rounded-circle d-flex align-items-center justify-content-center fs-6 fw-bold" style="width: 50px; height: 50px; left: 20px;">
          10 Oct
        </div>
        <div class="d-flex mb-3 text-muted small">
          <div class="me-4">
            <span class="text-primary me-2"><i class="bi bi-chat-dots"></i></span>
            <span>02 Comments</span>
          </div>
          <div>
            <span class="text-primary me-2"><i class="bi bi-person"></i></span>
            <span>Admin</span>
          </div>
        </div>
        <h5 class="card-title mb-3">
          <a href="/" class="text-dark text-decoration-none hover-text-primary">What is vent mode in air conditioner?</a>
        </h5>
        <a href="https://api.whatsapp.com/send?phone=+971582828757" class="btn btn-link text-primary text-decoration-none p-0 d-inline-flex align-items-center">
 ...
 <!--  <div class="col-lg-4">
    <div class="card border-0 h-100 shadow-sm hover-shadow-lg transition-all">
      <a href="/" class="overflow-hidden">
        <img src="Assets/HVAC-Contractor.avif" class="card-img-top w-100 hover-zoom" alt="HVAC Contractor in Dubai: Your Ultimate Guide 2023" loading="lazy">
      </a>
      <div class="card-body position-relative bg-white rounded-bottom p-4">
        <div class="position-absolute top-0 start-0 translate-middle-y bg-primary text-white rounded-circle d-flex align-items-center justify-content-center fs-6 fw-bold" style="width: 50px; height: 50px; left: 20px;">
          10 Oct
        ...
        <h5 class="card-title mb-3">
          <a href="/" class="text-dark text-decoration-none hover-text-primary">HVAC Contractor in Dubai: Your Ultimate Guide 2023</a>
        </h5>
        <a href="https://api.whatsapp.com/send?phone=+971582828757" class="btn btn-link text-primary text-decoration-none p-0 d-inline-flex align-items-center">
          <span class="fw-bold me-2">Read More</span>
          <i class="bi bi-arrow-right-short fs-5"></i>
  ...
  <!-- <div class="col-lg-4">
    <div class="card border-0 h-100 shadow-sm hover-shadow-lg transition-all">
      <a href="/" class="overflow-hidden">
        <img src="Assets/Top-Load-Washing-Machine.avif" class="card-img-top w-100 hover-zoom" alt="Top-Loading Washing Machines" loading="lazy">
      </a>
      <div class="card-body position-relative bg-white rounded-bottom p-4">
        <div class="position-absolute top-0 start-0 translate-middle-y bg-primary text-white rounded-circle d-flex align-items-center justify-content-center fs-6 fw-bold" style="width: 50px; height: 50px; left: 20px;">
          10 Oct
        ...
        <h5 class="card-title mb-3">
          <a href="/" class="text-dark text-decoration-none hover-text-primary">Top-Loading Washing Machines</a>
        </h5>
        <a href="https://api.whatsapp.com/send?phone=++971582828757" class="btn btn-link text-primary text-decoration-none p-0 d-inline-flex align-items-center">
          <span class="fw-bold me-2">Read More</span>
          <i class="bi bi-arrow-right-short fs-5"></i>
...
<style>
  ...
  .card-body {
    ...
    <!-- <div class="position-absolute" style="top: 50%; left: 0; transform: translateY(-50%);">
      <img src="Assets/new-and-update-png-image.png" loading="lazy" alt="AC Service" class="img-fluid">
    </div> -->
  </div>
</section>
    ...
    <div class="row g-4">
      <div class="col-xl-3 col-md-6">
        <div class="card border-0 h-100 bg-white rounded-4">
          <div class="card-body text-center p-4">
            <div class="mb-4">
              <img src="images/download12.jpeg" loading="lazy" alt="icon" class="img-fluid" style="max-width: 80px; height: auto;">
            </div>
            <h5 class="card-title mb-3"> Book Your Service   </h5>
            <p class="card-text">Book your service now for fast, reliable pick up and delivery in Dubai.
      ...
      <div class="col-xl-3 col-md-6">
        <div class="card border-0 h-100 bg-white rounded-4">
          <div class="card-body text-center p-4">
            <div class="mb-4">
              <img src="images/8159937.png" loading="lazy" alt="icon" class="img-fluid" style="max-width: 80px; height: auto;">
            </div>
            <h5 class="card-title mb-3">Pack Your Good</h5>
            <p class="card-text">Pack your goods safely and let us handle the fast, secure delivery process.</p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card border-0 h-100 bg-white rounded-4">
          <div class="card-body text-center p-4">
            <div class="mb-4">
              <img src="images/download13.jpeg" loading="lazy" alt="icon" class="img-fluid" style="max-width: 80px; height: auto;">
            </div>
            <h5 class="card-title mb-3">Safe Loading</h5>
            <p class="card-text">Safe loading by professionals to protect your items during delivery.</p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card border-0 h-100 bg-white rounded-4">
          <div class="card-body text-center p-4">
            <div class="mb-4">
              <img src="images/download14.jpeg" loading="lazy" alt="icon" class="img-fluid" style="max-width: 80px; height: auto;">
            </div>
            <h5 class="card-title mb-3">Safe Delivery</h5>
            <p class="card-text">Safe delivery guaranteed with care, speed, and real-time tracking updates.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-3 mb-4">
        <div class="footer-widget">
          ...
          <p class="mb-4">We offer fast, safe, and affordable pick up and delivery services in Dubai with same-day service and real-time tracking.</p>
        ...
        <div class="footer-widget">
          ...
          <ul class="list-unstyled">
            ...
            <li class="mb-3 d-flex">
              ...
              <div>
                <a href="tel:+971582828757" class="text-white text-decoration-none d-block">+971582828757</a>
            ...
            <li class="d-flex">
              ...
              <a href="mailto:
info@pickupdeliverydubai.com" class="text-white text-decoration-none">
info@pickupdeliverydubai.com</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="d-md-flex justify-content-between align-items-center">
        <div class="mb-3 mb-md-0">
          <span class="text-light">Copyright © 2025 <a href="/" class="text-light text-decoration-none">  Designed By Innovative Technologies</a>. All Rights Reserved.</span>
        </div>
        <div>
  ...
  <div class="d-block d-lg-none fixed-bottom d-flex justify-content-end p-3" style="z-index: 1000;">
    <div class="d-flex">
      ...
      <a href="https://api.whatsapp.com/send?phone=+971582828757" class="btn btn-success rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
 ...
 <div class="position-fixed bottom-0" style="z-index: 999;">
  <!-- Call button - visible on all devices -->
  <div class="start-0 mb-3 ms-3 mb-lg-5 ms-lg-5">
    <a href="tel:+971582828757" class="d-flex align-items-center text-decoration-none">
      <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 40px; height: 40px;">
        <i class="bi bi-telephone"></i>
      </div>
      <span class="bg-dark text-white px-3 py-2 rounded d-none d-md-inline-block">+971582828757</span>
    </a>
  </div>
</div>
...
<style>
  ...
  <div style="position: fixed; bottom: 13px; right: 0px;">
    <a href="https://api.whatsapp.com/send?phone=+971582828757" class="d-flex align-items-center text-decoration-none">
