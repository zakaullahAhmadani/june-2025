...
<title>services-24/7 Furniture & Appliance Pickup and Delivery Service in Dubai | +971 58 912 5005</title>  
@include('meta')  
...
<meta name="robots" content="index, follow">  
    ...
    /* Hero Section */
    .hero-contact {
background:linear-gradient(135deg,rgba(0,95,115,0.9)0%,rgba(10,147,150,0.9)100%),url('images/services.webp') no-repeat center center/cover;
        color: var(--white);
        padding: 3rem 1rem;
        text-align: center;
    }
...
<body>
  @include('navbar')
   <section class="hero-contact">
        <div class="container">
            <h1>Services</h1>
            <p>Expert same-day furniture & appliance pickup and delivery across Dubai – sofas, fridges, washing machines & more, handled with care!</p>
        </div>
    </section>
    @include('What We Do')
