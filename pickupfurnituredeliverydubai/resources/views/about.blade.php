...
<title>about-24/7 Furniture & Appliance Pickup and Delivery Service in Dubai | +971 58 912 5005</title>  
@include('meta')  
...
html, body {
    ...
    /* Hero Section */
    .hero-contact {
       background:linear-gradient(135deg,rgba(0,95,115,0.9)0%,rgba(10,147,150,0.9)100%),url('images/about.webp') no-repeat center center/cover;
        color: var(--white);
        padding: 3rem 1rem;
        text-align: center;
    }
