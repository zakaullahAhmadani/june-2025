...
<body data-rsssl=1
    ...
    --accent-color: #e53935;     /* Red (for accents, matches primary) */
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="hero-title animate__animated animate__fadeInDown">Contact</h1>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0 animate-fade-in animate-delay-1">
                    <div class="section-title">
                        <span class="pre-heading">Contact Us</span>
                        <h2 class="main-heading">Drop us a Line.</h2>
                        <p class="sub-heading">Whether you need digital marketing, web development, creative design, or advertising solutions, our team at Innovative Technologies is ready to help you achieve success.</p>
                    </div>
                    
                    <ul class="feature-list">
                        <li class="feature-item animate-slide-up animate-delay-1">
                            <i class="fas fa-check-circle feature-icon"></i>
                            <span class="content-wrap">Available 24/7 for Help</span>
                        </li>
                        <li class="feature-item animate-slide-up animate-delay-2">
                            <i class="fas fa-check-circle feature-icon"></i>
                            <span class="content-wrap">Ready to Deliver the Best</span>
                        </li>
                    </ul>
                </div>
