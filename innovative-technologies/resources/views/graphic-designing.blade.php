...
<head>
    ...
    <title>Graphic - Innovative Technologies</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="title-group text-center">
                    <h1 class="main-title">Graphic Designing</h1>
                </div>
...
<main id="main-content">
    <div class="container">
        ...
        <section class="pricing-section py-5">
            <div class="row">
                <div class="col-12">
                    <h2 class="section-title text-center mb-5">Graphics & Branding Design</h2>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="price-card h-100 shadow-sm">
                        ...
                        <ul class="price-features list-unstyled">
                            <li><i class="fas fa-check text-success"></i> Logo Design: Simple</li>
                            <li><i class="fas fa-check text-success"></i> Social Media Posts: 5 Posts</li>
                            <li><i class="fas fa-times text-danger"></i> Business Card & Flyer Design</li>
                            <li><i class="fas fa-times text-danger"></i> Motion Graphics & Animation</li>
                        </ul>
                ...
                <div class="col-md-4 mb-4">
                    <div class="price-card h-100 shadow-sm">
                        ...
                        <div class="price-amount">
                            <span class="price-currency">AED</span>
                            <span class="price-integer">120</span>
                            <span class="price-period">Monthly</span>
                        </div>
                        <ul class="price-features list-unstyled">
                            <li><i class="fas fa-check text-success"></i> Logo Design: Branding Kit</li>
                            <li><i class="fas fa-check text-success"></i> Social Media Posts: 10 Posts</li>
                            <li><i class="fas fa-check text-success"></i> Business Card & Flyer Design: Included</li>
                            <li><i class="fas fa-check text-success"></i> Motion Graphics & Animation: Basics</li>
                        </ul>
                        <div class="price-footer">
                            <a href="http://wa.me/+971508097203" class="price-btn">Select Plan</a>
                        </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="price-card h-100 shadow-sm">
                        ...
                        <ul class="price-features list-unstyled">
                            <li><i class="fas fa-check text-success"></i> High-End Custom Logo</li>
                            <li><i class="fas fa-check text-success"></i> Social Media Posts: 50+ Posts</li>
                            <li><i class="fas fa-check text-success"></i> Business Card & Flyer Design: Premium</li>
                            <li><i class="fas fa-check text-success"></i> Motion Graphics & Animation: Advanced</li>
                        </ul>
                        <div class="price-footer">
                            <a href="http://wa.me/+971508097203" class="price-btn">Select Plan</a>
                        </div>
...
<span class="phone">
  ...
  <a href="your-document.pdf" download class="text-decoration-none text-reset">
    <div class="download-box">
      ...
      <div class="download-content"style="margin-left: 20px;">
        ...
        <section class="content-section py-5">
            <div class="row">
                <div class="col-12">
                    <div class="service-img text-center mb-5">
                        <img src="images/a0d92f19-c933-4603-8b5a-eb28d0d0938e.png" alt="Graphic Designing Services" class="img-fluid rounded-lg shadow">
                    </div>
                    <h2 class="section-title text-center mb-4">Graphic Designing</h2>
                    <p class="lead text-center mx-auto" style="max-width: 800px;">Your brand's visual identity is one of the first things potential customers will notice. A strong, consistent brand identity can help you stand out in a crowded market, build trust with your audience, and communicate your values effectively.</p>
                    <p class="text-center mx-auto" style="max-width: 800px;">We offer Graphics & Branding Design Services to create stunning visuals that reflect the essence of your business and make a lasting impression.</p>
                    
                    <h3 class="mt-5 mb-4 text-center">Create a Powerful Visual Identity for Your Brand</h3>
                    <p class="mx-auto" style="max-width: 800px;">A well-crafted brand identity does more than just look good—it builds recognition, fosters emotional connections with customers, and communicates your business's values at a glance. Here's why graphics and branding are vital.</p>
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-md-6 mb-4">
                    <div class="icon-box p-4 h-100 shadow-sm rounded-lg">
                        ...
                        <h3 class="title mb-3">Brand Identity Design</h3>
                        <p>A strong brand identity is more than just a logo—it includes your color palette, typography, visual elements, and overall style. Our brand identity design services will help you:</p>
                        <ul class="mt-3 pl-3">
                            <li class="mb-2">Establish a memorable visual identity</li>
                            <li class="mb-2">Create consistent branding across all platforms</li>
                            <li class="mb-2">Develop brand guidelines for future use</li>
                ...
                <div class="col-md-6 mb-4">
                    <div class="icon-box p-4 h-100 shadow-sm rounded-lg">
                        ...
                        <h3 class="title mb-3">Social Media Graphics</h3>
                        <p>Social media platforms are where you engage with your audience. Our social media graphic design services help you create eye-catching, engaging visuals that align with your brand identity, including:</p>
                        <ul class="mt-3 pl-3">
                            <li class="mb-2">Platform-specific post designs</li>
                            <li class="mb-2">Story and reel graphics</li>
                            <li class="mb-2">Cover photos and profile images</li>
            ...
            <div class="row mt-5 align-items-center">
                <div class="col-md-6 mb-4">
                    <div class="service-img shadow rounded-lg overflow-hidden">
                        <img src="images/service-img1.jpg" alt="Graphic Designing Services" class="img-fluid w-100">
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <h2 class="section-title mb-3">Our Graphic Designing Services:</h2>
                    <p class="lead">We create unique and memorable logos that define your brand identity. Our branding services include:</p>
                    <p>From logos to complete brand guidelines, we provide comprehensive graphic design solutions tailored to your business needs.</p>
                </div>
            </div>
            ...
            <div class="row mt-5 align-items-center">
                <div class="col-md-6 mb-4 order-md-2">
                    <div class="service-img shadow rounded-lg overflow-hidden">
                        <img src="images/service-img2.jpg" alt="Graphic Design Services" class="img-fluid w-100">
                    </div>
                </div>
                <div class="col-md-6 mb-4 order-md-1">
                    <h3 class="mb-4">Our Design Services</h3>
                    <ul class="service-list list-unstyled">
                        <li class="mb-3 d-flex align-items-start">
                            <i class="fas fa-check text-success mt-1 me-2"></i>
                            <div>
                                <strong>Logo Design & Branding</strong>
                            </div>
                        </li>
                        <li class="mb-3 d-flex align-items-start">
                            <i class="fas fa-check text-success mt-1 me-2"></i>
                        ...
                        <li class="mb-3 d-flex align-items-start">
                            <i class="fas fa-check text-success mt-1 me-2"></i>
                            <div>
                                <strong>Infographics & Illustrations</strong>
                            </div>
                        </li>
                        <li class="mb-3 d-flex align-items-start">
                            <i class="fas fa-check text-success mt-1 me-2"></i>
                            <div>
                                <strong>Advertising & Promotional Design</strong>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="accordion-item border-0 mb-3">
                <h3 class="accordion-header" id="headingOne">
                    <button class="accordion-button collapsed py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        <span class="me-2 text-wrap text-start">Why is branding important for my business?</span>
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                    <div class="accordion-body pt-0">
                        <p class="mb-0">Branding helps create a unique identity for your business, making you instantly recognizable to your target audience. A strong brand builds trust, fosters customer loyalty, and differentiates you from competitors. It communicates your business values and personality, establishing a deeper connection with your customers.</p>
                    </div>
                </div>
            </div>
            <div class="accordion-item border-0 mb-3">
                <h3 class="accordion-header" id="headingTwo">
                    <button class="accordion-button py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                        <span class="me-2 text-wrap text-start">What's the difference between a logo and brand identity?</span>
                        <span class="accordion-icon">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                    <div class="accordion-body pt-0">
                        <p class="mb-0">A <strong>logo</strong> is a graphic representation or symbol that identifies your brand, while <strong>brand identity</strong> encompasses the complete visual representation of your business, including colors, typography, logos, imagery, and tone of voice. Brand identity defines how your business is perceived across all touchpoints.</p>
                    </div>
                </div>
            </div>
            <div class="accordion-item border-0 mb-3">
                <h3 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        <span class="me-2 text-wrap text-start">How long does it take to design a logo or brand identity?</span>
                        <span class="accordion-icon">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus d-none"></i>
                        </span>
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                    <div class="accordion-body pt-0">
                        <p class="mb-0">The timeline for logo or brand identity design can vary depending on the complexity of the project and the number of revisions needed. Typically, it takes anywhere from 1 to 3 weeks to complete. We'll keep you updated every step of the way to ensure you're satisfied with the design direction.</p>
                    </div>
                </div>
            </div>
            <div class="accordion-item border-0 mb-3">
                <h3 class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        <span class="me-2 text-wrap text-start">Do you offer revisions on your design work?</span>
                        <span class="accordion-icon">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus d-none"></i>
                        </span>
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                    <div class="accordion-body pt-0">
                        <p class="mb-0">Yes! We offer revisions on all design projects to ensure that you're completely happy with the final result. We provide an initial design concept, and then work closely with you to make any adjustments based on your feedback until we arrive at the perfect design.</p>
                    </div>
                </div>
            </div>
        </div>
...
<style>
    ...
    /* Text wrapping */
    .accordion-button span.text-wrap {
        flex-grow: 1;
