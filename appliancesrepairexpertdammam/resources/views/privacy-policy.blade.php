...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
     ...
     <title>Privicy-Appliance Repair Expert Dammam</title>
  ...
  <div class="container py-5" dir="rtl" >
    <div class="privacy-policy">
      ...
      <p><strong>النص المقترح:</strong> عنوان موقعنا الإلكتروني هو: 
        <a href="https://appliancesrepairexpertdammam.shop" target="_blank">
         https://appliancesrepairexpertdammam.shop
        </a>.
      </p>
      ...
      <p>قد يتم تقديم سلسلة مجهولة تم إنشاؤها من عنوان بريدك الإلكتروني (تُسمى أيضًا Hash) إلى خدمة Gravatar لمعرفة ما إذا كنت تستخدمها. سياسة الخصوصية لخدمة Gravatar متاحة هنا: 
        <a href="https://appliancesrepairexpertdammam.shop/privacy-policy/" target="_blank">
         https://appliancesrepairexpertdammam.shop/privacy-policy/
