...
<body>
  <div class="container py-5">
    <div class="privacy-policy">
      ...
      <h2>Who we are</h2>
      <p><strong>Suggested text:</strong> Our website address is: <a href="https://batteryserviceuae.com" target="_blank">https://batteryserviceuae.com</a>.</p>
      ...
      <p>An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: <a href="https://batteryserviceuae.com/privacy-policy/" target="_blank">https://batteryserviceuae.com/privacy-policy/</a>. After approval of your comment, your profile picture is visible to the public in the context of your comment.</p>
