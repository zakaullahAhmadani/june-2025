...
<title> الرياض | مركز صيانة متكامل للمكيفات والثلاجات والغسالات | فنيون معتمدون 24/7 | 0501676359</title>
   @include('Meta')
...
<body>
   ...
   <section class="hero" dir="rtl">
    <div class="hero-content">
        <h1>إصلاح وصيانة المكيفات والثلاجات والغسالات في الرياض</h1>
        <p>نقدم خدمات صيانة متكاملة للمكيفات والثلاجات والغسالات الأتوماتيكية باحترافية عالية. فريق فني متخصص - خدمة 24 ساعة - ضمان على جميع أعمال الصيانة</p>
   
        <a href="https://wa.me/966501676359" class="whatsapp-hero-btn pulse">
