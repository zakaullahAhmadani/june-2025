...
<section class="hero-contact" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('images/services.webp'); background-size: cover; background-position: center; padding: 80px 0; text-align: center;">
  <div class="container">
    <h1 style="color: var(--text-white); font-size: 2.5rem; margin-bottom: 15px;">Services</h1>
