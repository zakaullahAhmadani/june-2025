...
<section class="ac-section">
    <div class="ac-container">
        ...
        <div class="ac-content">
            ...
            <p>نقدم خدمات متكاملة لصيانة وتنظيف جميع أنواع المكيفات (سبليت، شباك، مركزي) في مدينة الرياض. فريقنا من الفنيين المتخصصين يضمن لكم أعلى معايير الجودة في الصيانة والإصلاح.</p>
            <p>مع خبرة واسعة في مجال التكييف، نقدم حلولاً شاملة تشمل التنظيف الدوري، الإصلاحات الفنية، تركيب المكيفات الجديدة، وصيانة جميع الماركات العالمية.</p>
            
            <div class="service-tags">
                <span class="service-tag">صيانة مكيفات سبليت</span>
                <span class="service-tag">تنظيف مكيفات بالرياض</span>
                <span class="service-tag">إصلاح أعطال التكييف</span>
                <span class="service-tag">تركيب مكيفات جديدة</span>
                <span class="service-tag">صيانة مكيفات مركزية</span>
                <span class="service-tag">غسيل مكيفات</span>
                <span class="service-tag">فني مكيفات متخصص</span>
                <span class="service-tag">تعبئة غاز المكيف</span>
                <span class="service-tag">إصلاح لوحات التحكم</span>
                <span class="service-tag">صيانة مكيفات شباك</span>
            </div>
            
            <a href="tel:+966537002015" class="call-now-btn">
                اتصل بنا الآن
