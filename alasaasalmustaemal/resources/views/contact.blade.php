...
<body>
 ...
 <section class="hero-section d-flex align-items-center justify-content-center text-center" style="
    background: url('{{ asset('images/WhatsApp Image 2025-07-23 at 12.16.01_68988295.jpg') }}') center center / cover no-repeat;
    height: 400px;
    position: relative;
">
    ...
    <div class="container position-relative">
        <h1 class="display-4 fw-bold text-black">اتصل بنا</h1>
        <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
            <ol class="breadcrumb bg-transparent p-0 m-0">
                ...
                <li class="breadcrumb-item active text-black" aria-current="page">اتصل بنا</li>
            </ol>
        </nav>
    </div>
</section>
