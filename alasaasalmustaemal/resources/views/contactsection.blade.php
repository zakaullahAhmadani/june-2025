    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-5 mb-lg-0">
        <div class="contact-info-card" style="background-color: #f8f9fa; border-radius: 10px; padding: 30px; height: 100%;">
          <h2 class="mb-4" style="color: #e74c3c;">تواصل معنا</h2>
          
          <!-- Email Card -->
          <div class="d-flex mb-4">
            <div class="icon-circle" style="background-color: #e74c3c; width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-left: 20px;">
              <i class="bi bi-envelope-fill" style="color: white; font-size: 1.2rem;"></i>
            </div>
            <div>
              <h5 style="color: black;">البريد الإلكتروني</h5>
              <p style="color: #6c757d;">info@alasaasalmustaemal.shop</p>
            </div>
          </div>
          ...
          <div class="d-flex mb-4">
            ...
            <div>
              ...
              <p style="color: #6c757d;">0501110433</p>
            </div>
          </div>
      ...
      <div class="col-lg-8">
        <div class="contact-form" style="background-color: white; border-radius: 10px; padding: 30px; box-shadow: 0 0 20px rgba(0,0,0,0.1);">
          <h2 class="mb-4" style="color: #e74c3c;">أرسل لنا رسالة</h2>
...
<section class="map-section py-5" style="background-color: #f8f9fa;" dir="rtl">
  <div class="container">
    <h2 class="text-center mb-5" style="color: #e74c3c;">موقعنا</h2>
